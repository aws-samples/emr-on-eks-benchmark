    ...
    "applicationConfiguration": [
      {
        ...
        "properties": {
          "spark.kubernetes.container.image": "'$ECR_URL'/eks-spark-benchmark:emr6.10_jdk11",
