...
aws emr-containers start-job-run \
  ...
  "sparkSubmitJobDriver": {
      ...
      "sparkSubmitParameters": "--class com.amazonaws.eks.tpcds.BenchmarkSQL --conf spark.driver.cores=2 --conf spark.driver.memory=3g --conf spark.executor.cores=3 --conf spark.executor.memory=5g --conf spark.executor.instances=63"}}' \
    ...
    "applicationConfiguration": [
      {
        ...
        "properties": {
          ...
          "spark.kubernetes.driver.podTemplateFile": "s3://'$S3BUCKET'/app_code/pod-template/driver-pod-template-ebs.yaml",
          "spark.kubernetes.executor.podTemplateFile": "s3://'$S3BUCKET'/app_code/pod-template/executor-pod-template-ebs.yaml",
